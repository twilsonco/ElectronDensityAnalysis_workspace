...
# Test comprehensive SystemGBDData writing with full ethane chemical system
function test_comprehensive_ethane_system()
    println("\n=== Comprehensive Ethane SystemGBDData Test ===")
    ...
    comprehensive_checkpoint = "gbd_checkpoints/ethane/comprehensive_ethane_1000dgb.jls"
    ...
    if system_gbd_data === nothing
        ...
        try
            system_gbd_data = gradient_bundle_decomposition(
                ...
                checkpoint_dir="gbd_checkpoints/ethane",
    ...
    try
        open_plt_file(
            "comprehensive_ethane_system_complete.plt",
            "Comprehensive Ethane System with Complete GBD Analysis",
            join(variables, ", "),
        )

        println("Writing complete SystemGBDData...")
        write_zone(
            "Comprehensive Ethane System",
            system_gbd_data;
            system=sys,
            variables=variables,
        ...
        file_size = filesize("comprehensive_ethane_system_complete.plt")
    ...
    # try
    #     open_plt_file(
    #         "comprehensive_ethane_system_cell_centered.plt",
    #         "Comprehensive Ethane System with Cell-Centered Data",
    #         join(variables, ", "),
    #     )

    #     println("Writing cell-centered SystemGBDData...")
    #     write_zone(
    #         "Comprehensive Ethane System CC",
    #         system_gbd_data;
    #         system=sys,
    #         variables=variables,
    ...
    #     # Get file size for reporting
    #     file_size_cc = filesize("comprehensive_ethane_system_cell_centered.plt")
...
println("Starting comprehensive ethane SystemGBDData test...")
...
test_passed = test_comprehensive_ethane_system()

println("\n=== Final Result ===")
if test_passed
    println("Comprehensive ethane SystemGBDData test PASSED! ✓")
    println("\nGenerated files:")
    println(
        "  📁 comprehensive_ethane_system_complete.plt - Complete system with node-centered spheres",
    )
    println(
        "  📁 comprehensive_ethane_system_cell_centered.plt - Complete system with cell-centered spheres",
    )
    println("\nFiles contain:")
    println("  ✓ System volumetric grid data")
    ...
    println("Comprehensive ethane SystemGBDData test FAILED! ✗")
end
