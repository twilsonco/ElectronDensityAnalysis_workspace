...
# Test comprehensive SystemGBDData writing with Au periodic system
function test_comprehensive_au_system()
    println("\n=== Comprehensive Au SystemGBDData Test ===")

    # Load Au system using band loader
    println("Loading Au system...")
    sys = nothing
    try
        sys = load_data_scm_band_t41(
            "/Users/haiiro/Downloads/Au_fcc_so.t41"; load_var="rho"
        )[1]
        println("✓ Successfully loaded Au system")
        println("  System: $(sys.name)")
        println("  Grid: $(sys.grid.n_pts)")
        println("  Atoms: $(length(sys.atoms))")
        println("  Periodicity: $(sys.is_periodic)")
    catch e
        println("✗ Failed to load Au data: $e")
        showerror(stdout, e)
        println()
        return false
    end
    ...
    comprehensive_checkpoint = "gbd_checkpoints/Au/comprehensive_au_1000dgb.jls"
    ...
    if system_gbd_data === nothing
        ...
        try
            system_gbd_data = gradient_bundle_decomposition(
                ...
                checkpoint_dir="gbd_checkpoints/Au",
    ...
    try
        open_plt_file(
            "comprehensive_au_system_complete_band.plt",
            "Comprehensive Au System with Complete GBD Analysis",
            join(variables, ", "),
        )

        println("Writing complete SystemGBDData...")
        write_zone(
            "Comprehensive Au System",
            system_gbd_data;
            system=sys,
            variables=variables,
        ...
        file_size = filesize("comprehensive_au_system_complete_band.plt")
    ...
    # try
    #     open_plt_file(
    #         "comprehensive_au_system_cell_centered.plt",
    #         "Comprehensive Au System with Cell-Centered Data",
    #         join(variables, ", "),
    #     )

    #     println("Writing cell-centered SystemGBDData...")
    #     write_zone(
    #         "Comprehensive Au System CC",
    #         system_gbd_data;
    #         system=sys,
    #         variables=variables,
    ...
    #     # Get file size for reporting
    #     file_size_cc = filesize("comprehensive_au_system_cell_centered.plt")
...
println("Starting comprehensive Au SystemGBDData test...")
...
test_passed = test_comprehensive_au_system()

println("\n=== Final Result ===")
if test_passed
    println("Comprehensive Au SystemGBDData test PASSED! ✓")
    println("\nGenerated files:")
    println(
        "  📁 comprehensive_au_system_complete_band.plt - Complete system with node-centered spheres",
    )
    println(
        "  📁 comprehensive_au_system_cell_centered.plt - Complete system with cell-centered spheres",
    )
    println("\nFiles contain:")
    ...
    println("Comprehensive Au SystemGBDData test FAILED! ✗")
end
